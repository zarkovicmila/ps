...
import domen.ZimskaOprema;import java.util.ArrayList;
...
public class ModelTabeleStavke extends AbstractTableModel {
    ...
    String[] kolone = {"Rb","Vrsta opreme", "Proizvodjac", "Kolicina", "Cena"};
    ...
    public ModelTabeleStavke(ArrayList<StavkaRentiranja> lista) {
        this.lista = lista;
    }
