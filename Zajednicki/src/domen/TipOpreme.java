 ...
 * @author milaz
 */
public class TipOpreme implements Serializable, OpstiDomenskiObjekat{
    private int tipID;
    ...
    public TipOpreme(int tipID, String naziv) {
        this.tipID = tipID;
        this.naziv = naziv;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final TipOpreme other = (TipOpreme) obj;
    ...
    public ArrayList<OpstiDomenskiObjekat> vratiListu(ResultSet rs) throws Exception {
        ...
        while(rs.next()) {
            ...
            TipOpreme to = new TipOpreme(id, naziv);
            lista.add(to);
        }
        return lista;
    }
